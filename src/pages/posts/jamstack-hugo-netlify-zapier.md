...
![Ink Directory listing](/images/jamstack-hugo-blog/ink_directory_listing.webp)
...
![Harbor Home Page](/images/jamstack-hugo-blog/ink-home-page.webp)
...
![New post on the home page](/images/jamstack-hugo-blog/new-post.webp)
...
![GitHub create new repository](/images/jamstack-hugo-blog/new-repo.webp)
...
![GitHub create repo screen](/images/jamstack-hugo-blog/github_create_repo.webp)

Then click the green button "Create repository."

You should see a screen that looks similar to this:

![GitHub empty repo screen](/images/jamstack-hugo-blog/github_empty_repo.webp)
...
![GitHub empty repo instructions](/images/jamstack-hugo-blog/github-instructions.webp)
...
![GitHub repo pushed](/images/jamstack-hugo-blog/github-repo-pushed.webp)
...
![Netlify Dashboard](/images/jamstack-hugo-blog/netlify-dashboard.webp)

Click on the "New site from Git" button.

On the next screen, click on the "GitHub" button.

![Netlify Connect to Git Provider](/images/jamstack-hugo-blog/netlify-git-provider.webp)
...
![Netlify Pick a repository](/images/jamstack-hugo-blog/netlify-pick-a-repo.webp)
...
![Netlify Deploy Settings](/images/jamstack-hugo-blog/netlify-deploy-settings.webp)
...
![Netlify Site Deployed Dashboard](/images/jamstack-hugo-blog/netlify-deployed-site-dashboard.webp)

Click on the green URL; it should take you to our new Hugo site!

![Broken Site](/images/jamstack-hugo-blog/netlify-site-broken.webp)
...
![Broken Site Dev Console](/images/jamstack-hugo-blog/broken-site-dev-console.webp)
...
![Netlify Site Fixed](/images/jamstack-hugo-blog/netlify-site-fixed.webp)
...
![Netlify CMS Admin Folder](/images/jamstack-hugo-blog/netlify_cms_admin_folder.webp)
...
![Netlify Identity](/images/jamstack-hugo-blog/netlify_identity.webp)
...
![Netlify Registration Preferences](/images/jamstack-hugo-blog/netlify_registration_preferences.webp)

You can leave the "Open" radio button selected for now and click "Save."

![Netlify Registration Preferences Open](/images/jamstack-hugo-blog/netlify_registration_preferences_open.webp)

Scroll down towards the bottom of the page and click on "Enable Git Gateway" under the "Services" heading.

![Netlify Enable Git Gateway](/images/jamstack-hugo-blog/netlify_services_git_gateway.webp)
...
![Netlify Identity Login](/images/jamstack-hugo-blog/netlify_identity_login.webp)
...
![Netlify Identity Signup](/images/jamstack-hugo-blog/netlify_identity_signup.webp)

Open the email and confirm your email address. You should now be logged in and presented with the CMS admin dashboard.

![Netlify CMS Dashboard](/images/jamstack-hugo-blog/netlify_cms_dashboard.webp)
...
![Netlify CMS Publish Button](/images/jamstack-hugo-blog/netlify_cms_publish_btn.webp)
...
![Netlify Build Hooks](/images/jamstack-hugo-blog/netlify_build_hooks.webp)

Click the "Add build hook" button.

Give your hook a name, and then save it.

![Netlify Build Hook Name](/images/jamstack-hugo-blog/netlify_build_hook_name.webp)

Netlify will then give you a URL for the webhook, like so:

![Netlify Build Hook Url](/images/jamstack-hugo-blog/netlify_build_hook_url.webp)
...
![Zapier Webhook Post](/images/jamstack-hugo-blog/zapier_webook_post.webp)

Click on the "Try it" button.

On the next screen, I set up mine to trigger on the weekends and at 7 am.

![Zapier Webhook Post](/images/jamstack-hugo-blog/zapier_every_day.webp)

After clicking "Save and Continue," click on the "Test Trigger" button.

![Zapier Test Trigger](/images/jamstack-hugo-blog/zapier_test_trigger.webp)

Then click on the 2nd section and add in the URL from Netlify. I set my payload type to "Raw."

![Zapier Post Setup](/images/jamstack-hugo-blog/zapier_post_setup.webp)
...
![Zapier Test Action](/images/jamstack-hugo-blog/zapier_test_action.webp)

If all goes well, you should see the following.

![Zapier Test Success](/images/jamstack-hugo-blog/zapier_test_success.webp)
...
![Netlify Hook Success](/images/jamstack-hugo-blog/netlify_hook_success.webp)
